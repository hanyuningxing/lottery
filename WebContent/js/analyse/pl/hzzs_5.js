...
TAB_HEADER = '<table width="100%" border="0" cellpadding="0" cellspacing="1" class="zstablegraybg" ><tr class="trtitlebg"><td width="60">@SELECT@</td><td >出号</td><td >和值</td>';
TAB_FOOTER ='<tr class="trtitlebg"><td>@SELECT@</td><td >出号</td><td >和值</td>';
MONI_SELECT ='<td class="trgray graychar333">模拟选号</td><td  >&nbsp;</td><td  >&nbsp;</td>';
for ( var sum = 0; sum < 46; sum++) {
	SUM_ARR.push(sum.toString());
	TAB_HEADER+='<td>'+sum+'</td>';
	TAB_FOOTER+='<td>'+sum+'</td>';
	MONI_SELECT+='<td><a href="#" class="gball" onclick="ball_click(this);return false">'+sum+'</a></td>';
}
TAB_HEADER+='<td >奇数<br />和值</td><td  >偶数<br />和值</td><td  >大数<br />和值</td><td  >小数<br />和值</td></tr>';
TAB_FOOTER+='<td >奇数<br />和值</td><td  >偶数<br />和值</td><td  >大数<br />和值</td><td  >小数<br />和值</td></tr></table>';
MONI_SELECT+= '<td  >&nbsp;</td><td  >&nbsp;</td><td  >&nbsp;</td><td  >&nbsp;</td>';
