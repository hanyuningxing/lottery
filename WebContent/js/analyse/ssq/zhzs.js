...
TAB_FOOTER = '<tr class=" zsttrpinklig "><td rowspan="2" class="trtitlebg"><select name="select2" size="1" id="select2" style="width:50px;" ><option>期号</option><option>大到小</option><option>小到大</option></select></td><td class="b1redpx">01</td><td>02</td><td>03</td><td>04</td><td>05</td><td>06</td><td>07</td><td>08</td><td>09</td><td>10</td><td>11</td><td class="b1redpx">12</td><td>13</td><td>14</td><td>15</td><td>16</td><td>17</td><td>18</td><td>19</td><td>20</td><td>21</td><td>22</td><td class="b1redpx">23</td><td>24</td><td>25</td><td>26</td><td>27</td><td>28</td><td>29</td><td>30</td><td>31</td><td>32</td><td>33</td><td class="b1redpx">重号 </td><td>连号<br />个数</td><td>和值</td><td>三区比</td><td>奇偶比</td><td rowspan="2" class="b1redpx trtitlebg">蓝球</td><td rowspan="2" class="trtitlebg">AC值</td></tr><tr class="trtitlebg"><td colspan="11" class="b1redpx">一区</td><td colspan="11" class="b1redpx">二区</td><td colspan="11" class="b1redpx">三区</td><td colspan="5" class="b1redpx">红球分析</td></tr></table>';
...
function genResult(numStr, issue, prevResult) {
	...
	result.redNums.each(function(redNum) {
		...
		if (prevNumInt != null && redNumInt - prevNumInt == 1) {
			continuousObj[redNumInt.toString()] = true;
			continuousObj[prevNumInt.toString()] = true;
		}
...
function buildMissItemHTML(issue, missItem) {
	...
	REDS.each(function(ball) {
		...
		var ballHtml = (miss == 0) ? '<span class="nballred">' + ball + '</span>' : miss;
