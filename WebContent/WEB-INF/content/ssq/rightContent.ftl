   ...
   <#if commonAnalyse??&&commonSingleAnalyse??>
	  ...
	  <div class="rigkuang" style="border-bottom:none;">
	    ...
	    <div class="zhuanjia"> <img src="${base}/pages/images/zj01.jpg" />
	      <div class="zhuanjiawz">${lotteryType.lotteryName!}${period.periodNumber!}期定蓝<em class="bluechar">${analyse!}</em><br />
	        红胆:<em class=" rebchar">${commonAnalyse!}</em><br />
	        定蓝:<em class=" bluechar">${analyse!}</em><br />
	      </div>
	    </div>
	    <!--zj 01 end-->
	    <!--zj 02 -->
	    <div class="zhuanjia"> <img src="${base}/pages/images/zj02.jpg" />
	      <div class="zhuanjiawz">${lotteryType.lotteryName!}${period.periodNumber!}期定蓝<em class="bluechar">${singleAnalyse!}</em><br />
  ...
  <!--专家推荐end-->
    ...
    <div class="rightkuangb1">
	 ...
	 <script type="text/javascript" language="javascript">
						var miss_data = null;
						if(typeof(ssq_max_miss)!="undefined"){ 
						     miss_data = ssq_max_miss;
						}
						if(null!=miss_data){
					           jsonArr = eval(miss_data);
					           var htmlTemp ='';
					           htmlTemp = get_max_miss('红球',jsonArr['redb'],jsonArr['reds'],true);
					           htmlTemp = htmlTemp+get_max_miss('蓝球',jsonArr['blueb'],jsonArr['blues'],true);
    ...
    <div class="rightkuangb1">
      <div class="kaijtishi" style="padding-bottom:4px;">
        ...
        <ul class="graybt_menu">
          <li><a href="<@c.url value="/${lotteryType.key!}/analyse!zhzs.action" />" target="_blank" style="margin-right:6px;">${lotteryType.lotteryName!}红球走势图</a></li>
          <li><a href="<@c.url value="/${lotteryType.key!}/analyse!lqzs.action" />" target="_blank">${lotteryType.lotteryName!}蓝球走势图</a></li>
        </ul>
        <ul class="graybt_menu">
