...
<link href="${base}/js/jquery/formValidator/style/validator.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${base}/js/jquery/formValidator/formValidator.js"></script>
<script type="text/javascript" src="${base}/js/user/bindMobile.js"></script>
<script type="text/javascript" src="${base}/js/cookie.js"></script>
<script type="text/javascript" src="${base}/js/jquery/formValidator/formValidatorRegex.js"></script>
<link href="${base}/pages/css/payper.css" rel="stylesheet" type="text/css" />
<style>
...
.window {height: 200PX;width: 480px;overflow: hidden;position: relative;margin-bottom:5px;}
.image_reel {position: absolute;top: 0;left: 0;}
.image_reel img {float: left;}
.paging {position: absolute;top: 165px;left: 0;width: 480px;height: 40px;z-index: 100;text-align:right;line-height: 40px; repeat-x 0 0;display: none;}
...
<div id="chongzhi" style="display:none">
   ...
   <div class="yhzxright">
    ...
    <div class="border04">
	  ...
	  <form action="${base}/user/fund!commTraceMarker.action" method="post" id="commTraceMarker_form"> 	  
...
<div id="payPer" style="display:none" class="zftsk">
		...
		<div class="zftsnr">
		  ...
		  <div class="fkanjg">
			...
			<a class="fkywt_an" href="${base}/info/assist/assist.action?type=bzzx-3czzn">付款遇到问题</a>
		  </div>
		</div>
		 <br />
	    <br />
  ...
  <div class="t1000wz"> <a href="${base}/" class="qklogo"></a>
    ...
    <div class="qklogin_middle">
      ...
      <div class="qklogin_middle" id="un_login_div">
	     <form action="${base}/user/user!login.action" method="post" id="userLoginForm">
    ...
    <div id="topmenu">
        ...
        <li><a id="navs1" href="${base}/jczq/scheme_subList.html">合买大厅</a></li>
...
<div class="w1000">
  <div class="mleft">
    <div class="klogin260">
      <div class="btlogin"><a <#if !loginUser??> href="${base}/user/user!login.action" onclick="$('#userquickLogin').dialog('open');return false;"</#if>>登录</a><a href="${base}/user/user!reg.action" style="border:none;">免费注册</a></div>
      <div class="newslist">
        <ul>
           <#if gonggaoList?? && gonggaoList?size gt 0>
				 <#list gonggaoList as data>
				 	<#if data.titleColor??>
				 		<#assign color=data.titleColor>
				 	</#if>
				   <li><a href="${base}/info/news-${data.id!}.html" target="_blank" style="color:${color}"><#if data.subType?? && data.subType!='NONE'>[${data.subType.typeName!}]&nbsp;&nbsp;</#if>${data.title!}</a></li>
				 </#list>
		   </#if>	       
        </ul>
      </div>
								                    ...
								                    <div class="image_reel">
								                        <#if adImagesList??&& adImagesList?size gt 0>
													    	  <#list adImagesList as data>
													    	     <a href="${data.link!}" target='_blank'><img src="${base}${data.name!}" alt="${data.word!}" width="480" height="200" title="${data.word!}"/></a>
													          </#list>
													    </#if>
								                    </div>
								                </div>
    ...
    <div class="zhuanjialist">
      <div class="zjleft"><img src="${base}/V1/images/jingyingtianxia.jpg" /></div>
      <div class="zjrig">
        <div class="d_img_title"> <span><a href="http://61.147.127.247:8012/forum.php?mod=forumdisplay&fid=40" target="_blank">更多>></a></span> <a href="#">竞赢天下</a> </div>
        <div class="d_img_char">简介：专长五大联赛，返奖率保持在87%以上，致力打造竞彩盈利跟单高分红团队。</div>
        <div class="bgline"></div>
        <ul class="zjlist">
           <#if meinvForecastList?? && meinvForecastList?size gt 0 >
				 <#list meinvForecastList as data>				    
				     	<li><a href="${base}/info/news-${data.id!}.html" target="_blank">${data.title!}</a></li>				 	
				 </#list>
		   </#if>	         
        </ul>
      </div>
    ...
    <!--砖家 list02 -->
    <div class="zhuanjialist2">
      <div class="zjleft"><img src="${base}/V1/images/pk.jpg" /></div>
      <div class="zjrig">
        <div class="d_img_title"> <span><a href="http://61.147.127.247:8012/forum.php?mod=forumdisplay&fid=40" target="_blank">更多>></a></span> <a href="#">竞彩PK王</a> </div>
        <div class="d_img_char">简介：主攻倍投，擅长赔率分析，专长做盈利发单计划。实力超群操盘手！</div>
        <div class="bgline"></div>
        <ul class="zjlist">
           <#if zhuanjiaForecastList?? && zhuanjiaForecastList?size gt 0 >
				 <#list zhuanjiaForecastList as data>				    
				     	<li><a href="${base}/info/news-${data.id!}.html" target="_blank">${data.title!}</a></li>				 	
				 </#list>
		   </#if>
        </ul>
  ...
  <#-- 合买LIST   
	<table width="750" border="0" align="center" cellpadding="00" cellspacing="0" style="border-collapse:collapse;" class="tableb1">
	  <tr align="center" class="tdtitle"  height="28">
	    <td><b class="hmorgchar">竞彩合买</b> | 用户名 </td>
	    <td>方案进度 </td>
	    <td>方案金额 </td>
	    <td>奖金范围</td>
	    <td>每份金额 </td>
	    ...
	    <#if top10Scheme?exists&&top10Scheme?has_content>
	             <#list top10Scheme?keys as key>
	                  <#list top10Scheme[key] as data>	
	                   <#if data.mode=='COMPOUND'>
							<#assign bestMinPrize=data.compoundContent.bestMinPrize>
							<#assign bestMaxPrize=data.compoundContent.bestMaxPrize>
						<#else>
							<#assign bestMinPrize=data.singleContent.bestMinPrize>
							<#assign bestMaxPrize=data.singleContent.bestMaxPrize>
							<#assign optimize=data.singleContent.optimize>
						</#if>
	                   	 <tr align="center" class="tdwhitelist" height="27" onmouseover="this.className='trhover'" onmouseout="this.className='tdwhitelist'" >		      
					        <td class="tc"><a href="${base}/blog/${data.sponsorId!}/" target="_blank">${data.sponsorName}</a></td>
			    	        <td class="hmbluechar"><#assign baodiProgressRate=data.baodiProgressRate!0 />
					            <span class="jindu">#{data.progressRate!0;M2}%</span>
					            <#if baodiProgressRate gt 0><span class="greenchar">+#{baodiProgressRate;M2}%</span><span style="color:red">(保)</span></#if></td>
					        <td >${data.schemeCost}元 </td>
					        <td><span style="color:red">${bestMinPrize?string.number}元~${bestMaxPrize?string.number}<span>元</td>
					        <td><#if data.minSubscriptionCost??>#{data.minSubscriptionCost;M2}元<#else>不限</#if></td>
					        <td>#{(data.remainingCost!0);M2}</td>
					        <td ><#if data.state=='UNFULL'><input id="subscribe_${data.id}" type="text" name="textfield" id="textfield" class="inputw80" onkeydown="number_check(this,event,0)" value="1" oncontextmenu="return false;" autocomplete="off"/><#else>${data.state.stateName}</#if>&nbsp;<#if data.state=='UNFULL'><a href="#" onclick="submitSubscribeReq(${data.id},'${data.lotteryType.key}');return false"><img src="${base}/V1/images/bugbti.gif" border="0" align="absmiddle" style="vertical-align:middle;"/></a><#else>${data.state.stateName}</#if></td>
					    	<td ><a href="${base}/${data.lotteryType.key}/scheme-${data.schemeNumber}.html" target="_blank">查看</a></td>
				    	</tr> 
				    </#list>
	              </#list>
	      </#if>   
	 ...
	 -->   
    <!-- 只需要这个二维码区域LIST -->
    <div class="qiu310_2wm">
      <!--[if !IE]>01 begin<![endif]-->
      <div class="qiu310_tywz"> <a href="#" class="qiu310_one"></a>
        <div class="qiu310_spanty"><a href="#">每天给你不同的赛事推荐</a></div>
      </div>
      <!--[if !IE]>01 end<![endif]-->
      <!--[if !IE]>02 begin<![endif]-->
      <div class="qiu310_tywz"> <a href="http://t.qq.com/qiuke310?preview" class="qiu310_one"></a>
        <div class="qiu310_spanty"><a href="http://t.qq.com/qiuke310?preview">竞彩投注技巧尽在腾讯微博</a></div>
      </div>
      <!--[if !IE]>02 end<![endif]-->
      <!--[if !IE]>03 begin<![endif]-->
      <div class="qiu310_tywz"> <a href="http://weibo.com/u/3911682072" class="qiu310_one"></a>
        <div class="qiu310_spanty"><a href="http://weibo.com/u/3911682072">每天给你不同的赛事推荐</a></div>
      </div>
      <!--[if !IE]>03 end<![endif]-->
      <!--[if !IE]>04 begin<![endif]-->
      <div class="qiu310_tywz"> <a href="${base}/download/qiu310.apk" class="qiu310_one"></a>
        <div class="qiu310_spanty"><a href="${base}/download/qiu310.apk">随时随地购彩</a></div>
      </div>
      <div class="cb"></div>
      <!--[if !IE]>04 end<![endif]-->
    </div>
  ...
  <div class="mright">
    <div class="mrig_rig">
 	<!--<div class="jiangchi">累计中奖：<b style="border-right:1px solid #ddd;"><#if ssqPeriodData??&&ssqPeriodData.prizePool??>${ssqPeriodData.prizePool?string('currency')}</#if></b></div>-->
      <div class="jiangchi">累计中奖：<b style="border-right:1px solid #ddd;"><#if yi??>${yi}</#if></b><span>亿</span>
      <b><#if qianwan??>${qianwan}</#if></b>
      <b><#if baiwan??>${baiwan}</#if></b>
      <b><#if shiwan??>${shiwan}</#if></b>
      <b style="border-right:1px solid #ddd;"><#if wan??>${wan}</#if></b><span>万</span></div>
      <div class="k5"></div>
      <div class="zjbg">最新中奖播报</div>
      <table width="240" border="0" align="center" cellpadding="00" cellspacing="0" style="border-collapse:collapse;" class="tableb1">
         ...
         <#if newestWonSubcriptionList?? && newestWonSubcriptionList?size gt 0>
         	<#list newestWonSubcriptionList as data>
	          <tr align="center" class="tdwhitelist"  >
	          	<!--${base}/blog/${data.sponsorId} -->
		          <td class="tc"><a href="${base}/blog/${data.sponsorId}/" target="_blank">${data.sponsorName}</a></td>
		          <td align="left"><a href="${base}/${data.lotteryType.key}/scheme!show.action?id=${data.schemeId}" target="_blank"> ￥${data.schemeCost} </a></td>
		          <td class="winchar">${data.schemePrizeAfterTax}</td>
	          </tr>
	        </#list>  
         </#if> 	       
      ...
      <div class="k10"></div>
      <!--rig new add list begin -->
      <div class="qiu_rig_border">
        <div class="qiu_rig_titlebg">竞彩投注技巧推荐</div>
        <div class="qiu310riglist">
          <ul >
            <#if jcSkillsList?? && jcSkillsList?size gt 0>
	         	<#list jcSkillsList as data>
	         	   <li><a href="${base}/info/news-${data.id!}.html" target="_blank">${data.title!}</a></li>	
		        </#list>  
	         </#if> 	  
          </ul>
  ...
  <div class="k10"></div>
  <div class="w1000">
    <div class="fl"><img src="${base}/V1/images/lc.gif" border="0" usemap="#Map" />
      <map name="Map" id="Map">
        <area shape="rect" coords="131,6,205,35" href="/info/assist/assist.action?type=bzzx-2zczn" />
        <area shape="rect" coords="252,6,324,35" href="/info/assist/assist.action?type=bzzx-3czzn" />
        <area shape="rect" coords="370,5,446,33" href="/info/assist/assist.action?type=bzzx-4gmzn" />
        <area shape="rect" coords="492,8,569,32" href="/info/assist/assist.action?type=bzzx-5zjzn" />
        <area shape="rect" coords="613,5,690,34" href="/info/assist/assist.action?type=bzzx-6tkzn" />
      </map>
    </div>
   <div class="fr"><a href="http://61.147.127.247:8012/forum.php?mod=forumdisplay&fid=45" class="senqinbt" style="background-position:0 -268px;"></a></div>
  </div>
</div>
<!-- friendlink -->
  <script type="text/javascript">
...
<div class="k10" id="k10"></div>
<!-- 流程end -->
<!-- bottom blue开始 -->
<div class="bottom100">
  <div class="w1000">
    <!-- m1 -->
    <div class="b_01"><a href="http://61.147.127.247:8012/forum.php?mod=forumdisplay&fid=45"><img src="${base}/pages/indexnew/images/sqpybt.gif" /></a></div>
    <div class="fl"><img src="${base}/pages/indexnew/images/shulinebottom.gif" /></div>
    <!-- m2 -->
    <div class="b_02">
      <!-- list 01 -->
      <div class="b02_01">
        <div class="bgall b02_01name"></div>
        <div class="botomlistwz">
          <ul class="bottomlist">
            <li><a href="${base}/user/user!reg.action">注册身份信息</a></li>
            <li><a href="${base}/user/fund!payPer.action" onclick="$SSO.login_auth(
						herder_checkIdCardAndRealNameExistForChongZhi(window.BASESITE+'/user/fund!payPer.action')
				);
			    return false;   ">投注和付款</a></li>
            <li><a href="${base}/user/scheme!list.action">查看订单</a></li>
            <li><a href="${base}/results!index.action">领奖与兑奖</a></li>
          </ul>
        </div>
      </div>
      <!-- list 02 -->
      <div class="b02_02">
        <div class="bgall b02_02name"></div>
        <div class="botomlistwz">
        <script>
        function checkIdCardAndRealNameExistForChongZhiAfterLogin(){
        	herder_checkIdCardAndRealNameExistForChongZhi(window.BASESITE+'/user/fund!payPer.action');
        }
        </script>
          <ul class="bottomlist">
            <li><a href="${base}/user/fund!payPer.action" onclick="$SSO.login_auth(
						checkIdCardAndRealNameExistForChongZhiAfterLogin
				);
			    return false;   ">支付宝支付</a></li>
            <li><a href="${base}/user/fund!payPer.action" onclick="$SSO.login_auth(
						checkIdCardAndRealNameExistForChongZhiAfterLogin
				);
			    return false;   ">信用卡支付</a></li>
            <li><a href="${base}/user/fund!payPer.action" onclick="$SSO.login_auth(
						checkIdCardAndRealNameExistForChongZhiAfterLogin
				);
			    return false;   ">网上银行支付</a></li>
            <li><a href="${base}/user/fund!payPer.action"onclick="$SSO.login_auth(
						checkIdCardAndRealNameExistForChongZhiAfterLogin
				);
			    return false;   " >快捷支付</a></li>
          </ul>
        </div>
      </div>
      <!-- list 03 -->
      <div class="b02_03">
        <div class=" bgall b02_03name"></div>
        <div class="botomlistwz">
          <ul class="bottomlist">
            <li><a href="${base}/info/assist/assist.action?type=bzzx-1cjwt">帮助中心</a></li>
            <li><a href="${base}/info/assist/assist.action?type=bzzx-1cjwt">常见问题</a></li>
            <li><a href="http://61.147.127.247:8012/forum.php?mod=forumdisplay&fid=52">意见及建议</a></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="fl"><img src="${base}/pages/indexnew/images/shulinebottom.gif" /></div>
    <!-- m3 -->
    <div class="fr"><a href="http://61.147.127.247:8012/forum.php?mod=forumdisplay&fid=45"><img src="${base}/pages/indexnew/images/bottomicon.png" /></a></div>
  </div>
</div>
<div class="cb friendnav"><b>友情链接：</b><a href="/dczc/scheme!editNew.action">北京单场</a> | <a href="http://www.68cai.com" target="_blank"> 68彩票 </a> | <a href="http://www.aicai.com/" target="_blank">爱彩网</a> | <a href="http://www.jiangduoduo.com" target="_blank">奖多多彩票网</a> | <a href="/jczq/scheme!editNew.action">竞彩足球</a></div>
<div class="cb quicknav"> 推荐彩票：<a href="/dczc/scheme!editNew.action">北京单场</a> | <a href="/sfzc/scheme!editNew.action?playType=SFZC14">胜负彩</a> | <a href="/jczq/scheme!editNew.action">竞彩足球</a> | <a href="/jclq/scheme!editNew.action">竞彩篮球</a> </div>
<!-- 页尾版权开始 -->
<div id="copyright">
  <div class="a10px">版权所有：深圳市米域高信息科技有限公司 Copyright © 2006-2013 <a href="http://www.miibeian.gov.cn" target="_blank" style="color:#004B91">工信部备案号：粤ICP备13039809号-1 </a><br />
   公司总部地址：广东省肇庆市端州区星湖大道维龙科技园3层 客服热线：400-688-4944 (早上8:30 - 晚上24:00)<br />
    友情提醒：理性购彩，健康生活。不向未满18周岁的青少年出售彩票<br />
  </div>
  <div style="height:124px;">
	  <a href="https://b.alipay.com/newIndex.htm" target="_blank"><img src="${base}/V1/images/zhifubaoshangjia.gif" border="0" align="center"/></a>
	  <a href="http://net.china.com.cn/" target="_blank"><img src="${base}/V1/images/police.gif" border="0" align="center"/></a>
	  <a href="http://www.miibeian.gov.cn" target="_blank"><img src="${base}/V1/images/link_3.gif" border="0" align="center"/></a>
	  <a key ="53186622af60043cbeb16e39"  logo_size="124x47"  logo_type="realname"  href="http://www.anquan.org" ><script src="http://static.anquan.org/static/outer/js/aq_auth.js"></script></a>
	  <a  key ="53186622af60043cbeb16e39"  logo_size="124x47"  logo_type="official"  href="http://www.anquan.org" ><script src="http://static.anquan.org/static/outer/js/aq_auth.js"></script></a>
	  <script language='javascript' type='text/javascript' id='gj_zhengshu'  src='http://pc2.gtimg.com/pcmgr/online_server/cert/3F/E3/gj_zhengshu_3fe32a1314f9105963c1d1d6a22c2c97.js?site=www.qiu310.com&token=3fe32a1314f9105963c1d1d6a22c2c97'></script> 
  </div>
</div>
<!-- 页尾版权信息结束 -->

<!--在线客服开始-->
<script language="javascript" src="http://chat.live800.com/live800/chatClient/monitor.js?jid=2659558135&companyID=291999&configID=122958&codeType=custom"></script>
<script type="text/javascript">
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-18091987-46']);
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fd11732758e058ea15959209587634e86' type='text/javascript'%3E%3C/script%3E"));
</script>

<!--跳回页头-->
<script type="text/javascript" src="${base}/js/scrolltop.js"></script>
<DIV style="DISPLAY: none; color:#FF0; line-height:18px;" id="goTopBtn"><IMG border=0 src="${base}/V1/images/lanren_top.jpg" alt="返回顶部"></DIV>
