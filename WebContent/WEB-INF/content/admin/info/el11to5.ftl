...
<div style="clear:both;">
	...
	<#-- if prvPeriod??>
	 ...
	 <#if curPeriod??>
	 <li>11选5第<span class="color_red">${curPeriod.periodNumber!}</span>期复式发起截止时间：<span class="color_red"><#if curPeriod.endedTime??>${curPeriod.endedTime?string("yyyy-MM-dd HH:mm")}</#if></span></li>
	 </#if>
...
<div class="title">
    ...
    <div class="l border_4">
      <table width="415" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="ball_ball padding_left5">01</td>
