...
<div style="clear:both;">
	...
	<#-- if prvPeriod??>
	 ...
	 <#if curPeriod??>
	 <li>快乐十分第<span class="color_red">${curPeriod.periodNumber!}</span>期复式发起截止时间：<span class="color_red"><#if curPeriod.endedTime??>${curPeriod.endedTime?string("yyyy-MM-dd HH:mm")}</#if></span></li>
	 </#if>
...
<div class="title">
    ...
    <div class="l border_4">
      <table width="431" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="41" class="ball_ball">01</td>
          <td width="41" class="ball_ball">02</td>
          <td width="41" class="ball_ball">03</td>
          <td width="41" class="ball_ball">04</td>
          <td width="41" class="ball_ball">05</td>
          <td width="41" class="ball_ball">06</td>
          <td width="41" class="ball_ball">07</td>
          <td width="41" class="ball_ball">08</td>
          <td width="103" class="ball_ball">09</td>
        </tr>
        <tr>
