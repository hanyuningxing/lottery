	    ...
	    <tbody id="matchTbody">
	      ...
	      <#if matchMap??>
	  		<#list matchMap.entrySet() as entry>
		        ...
		        <td colspan="${(itemArr?size)+9}" height="22" height="22" ><img height="15" width="35" align="absmiddle" src="<@c.url value="/pages/images/btyc.gif" />" onclick="dayFilter(this);" _di="${entry_index}" style="cursor:pointer;" /> <span class="boldchar">${entry.getKey()}（10：00 -- 次日 10：00）两队之间数字为让球数 “-”负号表示主队让客队</span></td>
			  </tr>
