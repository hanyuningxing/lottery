...
<#assign canChase=canChase!false />
				        ...
				        <tr height="24" class="trw">
				          <td align="left" class="left10">
							    ...
							    <select name="userName">
							     		        <option value="超级撒亚人">超级撒亚人</option>
							     		         <option value="howard">howard</option>
							     		        <option value="王兵888">王兵888</option>
							     		        <option value="528facai">528facai</option>
			 								    <option value="孩子他爸">孩子他爸</option>
											    <option value="ilovejie">ilovejie</option>
											   <option value="不吃腥的猫">不吃腥的猫</option>
												<option value="loves18">loves18</option>
												<option value="一买就中">一买就中</option>
												<option value="擅长机选">擅长机选</option>
												<option value="好彩007">好彩007</option>
												<option value="六合高手">六合高手</option>
												<option value="cosmo">cosmo</option>
												<option value="小小刘刘">小小刘刘</option>
												<option value="李云清00">李云清00</option>
												<option value="富贵彩中来">富贵彩中来</option>
												<option value="xlhua">xlhua</option>
												<option value="天天想中奖">天天想中奖</option>
												<option value="chenbo123">chenbo123</option>
												<option value="低调中奖">低调中奖</option>
												<option value="天天想中奖">天天想中奖</option>
												<option value="好彩一生">好彩一生</option>
												<option value="好彩1提款机">好彩1提款机</option>
												<option value="嘉555应">嘉555应</option>
												<option value="赢了又赢">赢了又赢</option>
												<option value="caiwin">caiwin</option>
												<option value="朝9晚5">朝9晚5</option>
												<option value="神啊救救我吧">神啊救救我吧</option>
												<option value="403房">403房</option>
												<option value="老婆不在家">老婆不在家</option>
												<option value="幸运zf">幸运zf</option>
												<option value="不想注册">不想注册</option>
												<option value="xiaohui">xiaohui</option>
												<option value="反正我信了">反正我信了</option>
												<option value="奶爸008">奶爸008</option>
												<option value="jian168">jian168</option>
												<option value="王国超1">王国超1</option>
												<option value="只爱好彩1">只爱好彩1</option>
												<option value="飞哥点杀">飞哥点杀</option>
												<option value="xjl1983">xjl1983</option>
												<option value="刘翔520">刘翔520</option>
												<option value="中奖养家糊口">中奖养家糊口</option>
												<option value="湖北小张">湖北小张</option>
												<option value="新手上路">新手上路</option>
												<option value="hui0753">hui0753</option>
								</select>			              
				          </td>
				        </tr>
			 			 <tr height="24" class="trw">
	      ...
	      <div align="center" class=" top5px">
	        ...
	        <label class="inputcheckbox graychar">我已阅读了《<a href="#">用户合买代购协议</a>》并同意其中条款</label>
	      </div>
	      
	      
	              <a href="#" onclick="createForm();" id="formSubmit"><img src="<@c.url value= "/pages/images/bt_goumai.gif"/>" /></a>
