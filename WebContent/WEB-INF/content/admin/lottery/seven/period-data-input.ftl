  ...
  <tr class="trw">
    ...
    <td align="left">
		...
		&nbsp;
		<select name="num8">
				<option value="">特别号码</option>
				<#list 1..30 as c>
					<option <#if num8??&&num8==c>selected="selected"</#if> value="${c}">${c!}</option>
				</#list>				
		</select>
    </td>
  </tr>
    ...
    <td align="left" colspan="2">
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#DCDCDC">
		  ...
		  <tr class="trw">
		    ...
		    <td align="left">
		    	<input type="text" name="periodData.prize.sevenPrize" value="${periodData.prize.sevenPrize!}" />
		    </td>
		    <td class="trhemaigray" align="right">七等奖注数：</td>
		    <td align="left">
		    	<input type="text" name="periodData.winUnit.sevenWinUnits" value="${periodData.winUnit.sevenWinUnits!}" />
		    </td>
		  </tr>
		  <tr class="trw">
