			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="vtable">
			    ...
			    <#list matchs as match>
					...
					<tr class="v02tr">
					  ...
					  <td><#if match.cancel>取消<#elseif match.homeScore?? && match.guestScore??>${match.homeScore}<#else>&nbsp;</#if></td>
					  <td class="red">${match.homeResult!}&nbsp;</td>
					...
					<tr class="v02tr">
					  ...
					  <td><#if match.cancel>取消<#elseif match.homeScore?? && match.guestScore??>${match.guestScore}<#else>&nbsp;</#if></td>
					  <td class="red">${match.guestResult!}&nbsp;</td>
					  <td>${betItem.toBetString()}</td>
					</tr>
		    		<#assign index=index+1 />
			    </#list>
