   	...
   	<div class="cleanboth k3px">
		  ...
		  <div class="all8px">
   		...
   		<@block name="content.form">
	   		<form id="createForm" action="<@c.url value="/${lotteryType.key}/scheme!create.action" />" method="post" autocomplete="off">
   				<#if isSingle>
					<div class="cleanboth">
			    ...
			    <#include '/WEB-INF/content/common/init_common_new.ftl' />
			</form>
   		</@block>
	</div>
</@override>