...
<#assign lotteryType=period.lotteryType />
      <div class="rightkuangb1">
	   <div class="rigtopbg">
        <div class="lefttc1">${lotteryType.lotteryName!}开奖公告</div>
        <div class="righttc"><a href="<@c.url value="/${lotteryType.key}/result.action?menuType=3"/>" class="graychar">历史开奖公告>></a></div>
      </div>
      <div class="kaijtishi">
        ...
        <div style="padding:8px 0px;">
          <ul class="kjball">
            ...
            <li class="redballsingle">${periodData.rsultArr[5]}</li>
            <li class="redballsingle">${periodData.rsultArr[6]}</li>
            <li class="blueballsingle">${periodData.rsultArr[7]}</li>
          </ul>
        </div>
    ...
    <div class="rightkuangb1">
	 ...
	 <script type="text/javascript" language="javascript">
						...
						if(null!=miss_data){
					           ...
					           var htmlTemp ='';
					           htmlTemp = get_max_miss('基号',jsonArr['redb'],jsonArr['reds'],true);
					           htmlTemp = htmlTemp+get_max_miss('特号',jsonArr['blueb'],jsonArr['blues'],true);
    ...
    <div class="rightkuangb1">
      <div class="kaijtishi" style="padding-bottom:4px;">
        ...
        <ul class="graybt_menu">
          <li><a href="<@c.url value="/${lotteryType.key}/analyse!chzs.action"/>" target="_blank" style="margin-right:6px;">${lotteryType.lotteryName!}综合走势图</a></li>
          <li><a href="<@c.url value="/${lotteryType.key}/analyse!dwzs.action"/>" target="_blank">${lotteryType.lotteryName!}定位走势图</a></li>
        </ul>
        <ul class="graybt_menu">
          ...
          <li><a href="<@c.url value="/${lotteryType.key}/analyse!fhzs.action"/>" target="_blank">重号走势图</a></li>
        </ul>
        <ul class="graybt_menu">
          <li><a href="<@c.url value="/${lotteryType.key}/analyse!hzzs.action"/>" target="_blank" style="margin-right:6px;">${lotteryType.lotteryName!}和值走势图</a></li>
          <li><a href="<@c.url value="/${lotteryType.key}/analyse!tmzs.action"/>" target="_blank">特码走势图</a></li>
        </ul>
        </div> 
    </div>
    <div class="kong10"></div>
