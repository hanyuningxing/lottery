...
<div class="main_cz_right">
    <div class="rightkuangb1">
      <div class="rigtopbg">
        <div class="lefttc">山东体彩11选5开奖号码</div>
    ...
    <div class="rightkuangb1">
      <div class="kaijtishi" style="padding-bottom:4px;">
        <div class="yelbgbt"><a href="/sdel11to5/analyse.action" target="_blank" ><font color="#c61d01">${lotteryType.lotteryName!}数据分析图表</font></a></div>
        <div class="kong10"></div>
        <ul class="graybt_menu">
          <li><a href="/sdel11to5/analyse.action" style="margin-right:6px;" target="_blank">综合走势图</a></li>
          <li><a href="/sdel11to5/analyse!qhzs.action" target="_blank">重号走势图</a></li>
        </ul>
        <ul class="graybt_menu">
          <li><a href="/sdel11to5/analyse!lhzs.action" target="_blank" style="margin-right:6px;">连号走势图</a></li>
          <li><a href="/sdel11to5/analyse!chpl.action" target="_blank">开奖号频率走势图</a></li>
        </ul>
        <ul class="graybt_menu">
          <li><a href="/sdel11to5/analyse!yilou.action?type=QEZX" target="_blank" style="margin-right:6px;">前二组选遗漏</a></li>
          <li><a href="/sdel11to5/analyse!yilou.action?type=QEDX" target="_blank">前二直选遗漏</a></li>
        </ul>
        <ul class="graybt_menu">
          <li><a href="/sdel11to5/analyse!yilou.action?type=RAND2" target="_blank" style="margin-right:6px;">任二遗漏</a></li>
          <li><a href="/sdel11to5/analyse!yilou.action?type=RAND3" target="_blank">任三遗漏</a></li>
        </ul>
        </div> 
    </div>
    ...
    <div class="rightkuangb1">
      <div class="chuhaobg">
        <div class="chuhaobglef">山东体彩11选5奖金对照</div>
    ...
    <div class="kong10"></div>
      <div class="rightkuangb1">
      <div class="chuhaobg">
        <div class="chuhaobglef">山东体彩十一运夺金</div>
      </div>
...
<div class="rightkuangb1">
      <div class="kaijtishi" style="padding-bottom:4px;">
        <div class="yelbgbt"><a href="#" target="_blank" ><font color="#c61d01">山东体彩${lotteryType.lotteryName!}新闻资讯</font></a></div>
        <div class="kong10"></div>    
        <ul class="graybt_menu">
          <li><a href="/ch/ZPD_SDEL11TO5_FORECAST.htm" target="_blank" onmouseover="chg(0);"} style="margin-right:6px;"><h2>${lotteryType.lotteryName!}预测分析</h2></a></li>
          <li><a href="/ch/ZPD_SDEL11TO5_SKILLS.htm" target="_blank" onmouseover="chg(1);"><h2>${lotteryType.lotteryName!}投注技巧</h2></a></li>	 
        </ul>
        ...
        <ul class="graybt_menu">
          <li><a href="/ch/ZPD_SDEL11TO5_RESULTNOTICE.htm" target="_blank" style="margin-right:6px;" onmouseover="chg(2);"><h2>${lotteryType.lotteryName!}开奖号码</h2></a></li>
          <li><a href="/ch/ZPD_SDEL11TO5_INFO.htm" target="_blank" onmouseover="chg(3);"><h2>${lotteryType.lotteryName!}热点新闻</h2></a></li>
        </ul>
