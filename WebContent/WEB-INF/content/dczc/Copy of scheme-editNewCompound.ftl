...
<@override name="initContent">
	...
	<form id="createForm" action="${base}/${lotteryType.key}/scheme!create.action" method="post" autocomplete="off" target="_blank">
		<div class="floatleft">
		  <div id="div_op">
		...
		<div class="floatrig">
	      <table width="405" cellspacing="1" cellpadding="0" border="0" class="dctbg">
	        ...
	        <tr height="50" class="trw">
	          <td align="left" class="left10">
	          	<span id="span_createForm_submit"><a id="formSubmit" onclick="submitCreateForm();return false;" href="#"><img src="<@c.url value="/pages/images/dcbtgoumai.gif" />"></a></span>
	          	<!--<#if playType??&&'SPF'==playType> 
	          		<span id="span_Filter_submit"><a id="filterSubmit" onclick="filterSubmit();return false;" href="javascript:void(0);" target="_blank"><img src="<@c.url value= "/pages/images/glq/zxgl_03.gif"/>"/></a></span>
	          	</#if>-->
		...
		<input type="hidden" name="filterForm.params" value="" id="params"/>
