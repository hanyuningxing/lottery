<head>
	<title>福彩3D开奖公告、号码详情_最新开奖_历史开奖 - ${webapp.webName}安全购彩平台</title>
    ...
    <div class="kj_dtwz">
      <table style="background:#fff; border-collapse:collapse; border:1px solid #E3E3E3;" bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938" border="1" align="center">
        <tr class="center_trgray" align="center" >
          <td height="30" colspan="3" class="font14char boldchar"><div class="kj_jtitle"> ${lotteryType.lotteryName!}最新开奖公告  第<span class="redc">${period.periodNumber!}</span>期</div></td>
        </tr>
      ...
      <div class="kj_number"> <span class="floatleft" style="padding-left:250px;">开奖号码：</span>
        ...
        <span style="display">
        <span class="floatleft" style="padding-left:20px;"><a href="javascript:void(0);" title="${periodData.result}" onclick="copyResult(this);return false;">复制号码</a></span> </div>
...
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <tr class="center_trw" align="center" >
          <td height="35" class="kj_buybg"><a href="${base}/${lotteryType.key}/analyse.action" class="graychar">${lotteryType.lotteryName}数据图表</a> | <a href="${base}/info/rule/rule.action?lottery=WELFARE3D" class="graychar">${lotteryType.lotteryName}玩法介绍</a> | <a href="${base}/info/rule/rule.action?lottery=WELFARE3D" class="graychar">${lotteryType.lotteryName}中奖细则</a></td>
        </tr>
        <tr class="center_trw" align="center" >
