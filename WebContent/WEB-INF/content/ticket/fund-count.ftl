<head>
	...
	<meta name="menu" content="fund_count" />
...
<div id="center_main">
  <!--左边开始-->
  <div class="cleft">
      <#assign left_menu = 'fund_count'/>
      <#include "left.ftl" />
  </div>
  <!--右边开始-->
  <div class="cright">
    <#include "/common/message.ftl" />
      <form action="<@c.url value='/ticket/user!fund_count.action' />" method="get" id="fundForm">
	    <div class="crighttop">
	    	<label>
