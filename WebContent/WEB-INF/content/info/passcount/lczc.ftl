        ...
        <div class="gg_left">
          <table width="465" height="94" border="0" cellpadding="0" cellspacing="1" class="gg_b trw">
            ...
            <tr align="center" class="trgray">
              ...
              <td colspan="2">${lczcData.zcMatchs[0].homeTeamName!}</td>
	          <td colspan="2">${lczcData.zcMatchs[1].homeTeamName!}</td>
	          <td colspan="2">${lczcData.zcMatchs[2].homeTeamName!}</td>
	          <td colspan="2">${lczcData.zcMatchs[3].homeTeamName!}</td>
	          <td colspan="2">${lczcData.zcMatchs[4].homeTeamName!}</td>
	          <td colspan="2">${lczcData.zcMatchs[5].homeTeamName!}</td>
            </tr>
            <tr class="trgray">
              <td  class="gg_tr2" height="20">&nbsp;</td>
	          <td>半</td>
	          <td>全</td>
	          <td>半</td>
	          <td>全</td>
	        ...
	        <tr class="cg" class="trgray">
	          <td height="20" align="center" class="gg_tr2">赛果</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[0].halfResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[0].fullResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[1].halfResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[1].fullResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[2].halfResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[2].fullResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[3].halfResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[3].fullResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[4].halfResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[4].fullResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[5].halfResult!}</td>
	          <td class="rebchar boldchar">${lczcData.zcMatchs[5].fullResult!}</td>
	        </tr>
          </table>
        </div>
        
        <div class="gg_rig"> 一等奖：<span class="redboldchar"><#if lczcData.firstWinUnits??>${lczcData.firstWinUnits?string('###,###')}</#if></span> 注，每注奖金<span class="redboldchar"><#if lczcData.firstPrize??>${lczcData.firstPrize?string('###,###')}</#if></span>元<br />
           
        
          全国销量：<span class="redboldchar"><#if lczcData.totalSales??>${lczcData.totalSales?string('###,###')}</#if> </span>元<br />
          奖池滚存：<span class="redboldchar"><#if lczcData.prizePool??>${lczcData.prizePool?string('###,###')}</#if></span>元 </div>
      </div>
      </#if>  
      ...
      <#if pagination??&& (pagination.result![])?size gt 0>
        <#list pagination.result as data>
          <tr class="center_trw" align="center" onMouseOver="this.className='center_trhover'" onMouseOut="this.className='center_trw'">
               ...
               <td><a href="<@c.url value='/lczc/scheme-${data.schemeNum!}.html' />" target="_blank">${data.schemeNum!}</td>
               <td>${data.units!}</td>
               ...
               <td><a href="<@c.url value='/lczc/scheme-${data.schemeNum!}.html' />" target="_blank">查看</a></td>
        </#list>
        <#else> 
         <tr class="center_trw" align="center" onMouseOver="this.className='center_trhover'" onMouseOut="this.className='center_trw'">
