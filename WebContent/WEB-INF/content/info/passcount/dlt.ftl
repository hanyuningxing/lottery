    ...
    <div id="demography" class="ui-tabs ui-widget ui-widget-content ui-corner-all">      
      <form action="<@c.url value="/passcount/index.action" />" method="get">
        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
          <li _name="demography_li" class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a href="<@c.url value='${baseUrl}&state=SUCCESS' />"><font color="#555555">全部成功</font></a></li>
           <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=SINGLE&state=SUCCESS&dltAdd=2' />"><font color="#555555">追加单式成功</font></a></li>
          <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=COMPOUND&state=SUCCESS&dltAdd=2' />"><font color="#555555">追加复式成功</font></a></li>
          <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=SINGLE&state=CANCEL&dltAdd=2' />"><font color="#555555">追加单式未成功</font></a></li>
          <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=COMPOUND&state=CANCEL&dltAdd=2' />"><font color="#555555">追加复式未成功</font></a></li>
          
          <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=SINGLE&state=SUCCESS&dltAdd=1' />"><font color="#555555">单式成功</font></a></li>
          <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=COMPOUND&state=SUCCESS&dltAdd=1' />"><font color="#555555">复式成功</font></a></li>
          <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=SINGLE&state=CANCEL&dltAdd=1' />"><font color="#555555">单式未成功</font></a></li>
          <li _name="demography_li" class="ui-state-default ui-corner-top"><a href="<@c.url value='${baseUrl}&mode=COMPOUND&state=CANCEL&dltAdd=1' />"><font color="#555555">复式未成功</font></a></li>
      ...
      <table border="1" cellspacing="0" cellpadding="0" bordercolor="#EF9E9E" style="border-collapse:collapse;" class="main b_top" width="100%" >
        <thead class="b_top">
          ...
          <tr class="head">                                        
            ...
            <td width="60">七等<br/>注数</td>
            <td width="60">八等<br/>注数</td>
            <td width="60">生肖<br/>注数</td>
            <td width="50">状态</td>
            <td width="40">跟单</td>
          </tr>
        </thead>
      ...
      <#if pagination??&& (pagination.result![])?size gt 0>
        ...
        <#if data_index%2==0><#assign trColor="trw" /><#else><#assign trColor="trgray" /></#if>
          <tr>
                ...
                <td><#if data.canSee??&&data.canSee><a href="<@c.url value='/dlt/scheme!show.action?schemeNumber=${data.schemeNum!}' />" target="_blank">${data.schemeNum!}</a><#else>****</#if></td>
                ...
                <td><#if data.seventhWinUnits??&&data.seventhWinUnitsWon??&&data.seventhWinUnitsWon><font color="red">${data.seventhWinUnits!}</font><#else>${data.seventhWinUnits!}</#if></td>
                <td><#if data.eighthWinUnits??&&data.eighthWinUnitsWon??&&data.eighthWinUnitsWon><font color="red">${data.eighthWinUnits!}</font><#else>${data.eighthWinUnits!}</#if></td>
                <td><#if data.select12to2WinUnits??&&data.select12to2WinUnitsWon??&&data.select12to2WinUnitsWon><font color="red">${data.select12to2WinUnits!}</font><#else>${data.select12to2WinUnits!}</#if></td>
