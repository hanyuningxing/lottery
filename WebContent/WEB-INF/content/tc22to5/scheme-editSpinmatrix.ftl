<head>
	...
	<link href="<@c.url value="/pages/css/tc22to5_suoshui.css"/>" rel="stylesheet" type="text/css" />
...
<div class="mainsuoshui b3px">
  ...
  <form id="shrinkForm" action="<@c.url value="/${lotteryType.key}/scheme!spinmatrix.action" />" method="post" autocomplete="off">
	  ...
	  <table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
	    ...
	    <tr>
	      <td valign="top"><div class="ssqss_sm">说明：旋转矩阵是许多彩民朋友采用的投注方法，能实现中5保4(只要选定的号码中含有5个正确的选号，结果肯定有一注含有4个正确的选号)，同时以极低的成本实现复试投注的效果。旋转矩阵，很多人使用的、效果真不错的、您的在线超级缩水工具！</div></td>
	    </tr>
	  </table>
  </form>
