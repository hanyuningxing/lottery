...
<#assign lotteryType=period.lotteryType />
      <div class="rightkuangb1">
	   <div class="rigtopbg">
        <div class="lefttc1">体彩22选5开奖公告</div>
      ...
      <div class="kaijtishi">
        ...
        <div class="top5px">
          <table width="100%" border="0" cellspacing="1" cellpadding="3" class="tbbge5">
            ...
            <tr class="trw">
              <td>三等奖</td>
              <td><#if periodData.winUnit.secondWinUnits??>${periodData.winUnit.thirdWinUnits}</#if></td>
              <td class="redc"><#if periodData.prize.secondPrize??>${periodData.prize.thirdPrize}</#if> 元</td>
            </tr>
          </table>
        </div>
    </div>
    ...
    <div class="rightkuangb1">
	 ...
	 <script type="text/javascript" language="javascript">
						...
						if(null!=miss_data){
					           ...
					           var htmlTemp ='';
					           htmlTemp = get_max_miss('号码',jsonArr['redb'],jsonArr['reds'],true);
   ...
   <div class="rightkuangb1">
      <div class="kaijtishi" style="padding-bottom:4px;">
        <div class="yelbgbt"><a href="${base}/${lotteryType.key}/analyse.action" target="_blank" ><font color="#c61d01">体彩${lotteryType.lotteryName!}数据分析图表</font></a></div>
        <div class="kong10"></div>
        <ul class="graybt_menu">
          <li><a href="${base}/${lotteryType.key!}/analyse!chzs.action" target="_blank" style="margin-right:6px;">${lotteryType.lotteryName!}综合走势图</a></li>
          <li><a href="${base}/${lotteryType.key!}/analyse!dwzs.action" target="_blank">${lotteryType.lotteryName!}定位走势图</a></li>
        </ul>
        <ul class="graybt_menu">
          <li><a href="${base}/${lotteryType.key!}/analyse!lhzs.action" target="_blank" style="margin-right:6px;">${lotteryType.lotteryName!}连号走势图</a></li>
          <li><a href="${base}/${lotteryType.key!}/analyse!fhzs.action" target="_blank">重号走势图</a></li>
        </ul>
       <ul class="graybt_menu">
          <li><a href="${base}/${lotteryType.key!}/analyse!hzzs.action" target="_blank" style="margin-right:6px;">${lotteryType.lotteryName!}和值走势图</a></li>
          <li><a href="${base}/${lotteryType.key!}/analyse!lsbd.action" target="_blank">历史开奖查询对比</a></li>
        </ul>
        </div> 
    </div>
    <div class="kong10"></div>
