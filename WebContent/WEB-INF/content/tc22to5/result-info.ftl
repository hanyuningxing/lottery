<head>
	<title>体彩22选5开奖公告、号码详情_最新开奖_历史开奖 - ${webapp.webName}安全购彩平台</title>
...
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <tr class="center_trw" align="center" >
          <td height="35" class="kj_buybg"><a href="${base}/${lotteryType.key}/analyse.action" class="graychar">22选5数据图表</a> | <a href="${base}/info/rule/rule.action?lottery=TC22TO5" class="graychar">22选5玩法介绍</a> | <a href="${base}/info/rule/rule.action?lottery=TC22TO5" class="graychar">22选5中奖细则</a></td>
        </tr>
        <tr class="center_trw" align="center" >
