...
<div class="w1000">
  ...
  <div class="jczqjjyh">
	...
	<div class="border04 marginb20">
	  	  <div class="jjyhtit white_FFF_14">第二步：手动调节</div>
	      <div style="color:#333;">
	...
	<div class="border04 marginb20">
	  	  <div class="jjyhtit white_FFF_14">第三步：中奖预测</div>
	      <div style="color:#333;" id="forcastDataHtml">
	        <table width="100%" cellpadding="8" cellspacing="1" bgcolor="#dae8f5" style="color:#333;" class="jjyhtab">
              <tr class="bgD5F6FD">
                ...
                <td height="30" align="left" bgcolor="#D5F6FD" id="updateForecastOper"><a id="updateForecastBtn" class="butjjyc button3" href="javascript:;" onclick="updateForecast();return false;" style="display:none"></a></td>
              </tr>
              <#if prizeForecasts??>
	...
	<div class="border04 marginb20">
	  	  <div class="jjyhtit white_FFF_14">第四步：确认投注信息</div>
	      <div style="color:#333;">
              ...
              <tr>
               ...
               <tr>
			        ...
			        <td bgcolor="#FFFFFF" class="pad010">
				        ...
				        <#else>
				        	<div id="scheme_unLogin">未登录 【<a href="javascript:void(0)" onclick="$SSO.login_auth(); return false;" class="blue_0091d4">登录</a>】</div>
				        </#if>
	...
	<input type="hidden" name="createForm.multiple" value="1" />
