...
<#assign passTypeArr=passTypeArr!(stack.findValue("@com.cai310.lottery.support.jclq.PassType@values()")) />
...
<@override name="content">
	<div class="tzleft">
		...
		<@block name="matchContent">
			<div id="jl_match" style="float:left; width:710px;">
		...
		<div class="k10"></div>
	    <div class="j9ts">
		  <div class="bro_af5529">竞彩篮球投注提示</div>
	      <div class="tzts bro_6D4F42"><span class="tztsl">1、</span><span class="tztsr">竞彩篮球全部玩法过关投注、及比分单关投注奖金为固定奖金，赛事选择界面显示仅为当前参考奖金。实际奖金以出票时刻固定奖金为准。</span></div>
