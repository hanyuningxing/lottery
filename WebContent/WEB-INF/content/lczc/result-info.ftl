...
<head>
	<title>六场足彩开奖公告、号码详情_最新开奖_历史开奖 - ${webapp.webName}安全购彩平台</title>
...
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <#if matchArr??>
	          ...
	          <td class="redboldchar" >${data.halfResult!} , ${data.result!}</td>
	        </tr>
		  </#list>
		</#if>
      </table>
...
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <tr class="center_trw" align="center" >
          <td height="35" class="kj_buybg"><a href="javascript:void(0);" class="graychar">${lotteryName}数据图表</a> | <a href="${base}/info/rule/rule.action?lottery=LCZC" class="graychar">${lotteryName}玩法介绍</a> | <a href="${base}/info/rule/rule.action?lottery=LCZC" class="graychar">${lotteryName}中奖细则</a></td>
        </tr>
        <tr class="center_trw" align="center" >
