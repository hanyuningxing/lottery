...
function init(playType,period){
	...
	if(playType=="1"){
 			url = "./../xml/szpl/zhixuan/hmtj/"+period+".xml";
 	}else{
 			url = "./../xml/szpl/zhixuan/wztj/"+period+".xml";
 	}
 	$.ajax({
		    url:url,
		    type: 'GET',
...
<div class="an_box_fc">
  ...
  <div class="an_title"><!--标题选项卡开始-->
    <ul>
      ...
      <li><a title="历史冷热号码分布" href="${base}/tzfb/tzfb!sp3_zx_link.action?playType=1&period=${curPeriod}&result=${result}&groupType=1">组选复式分析</a></li>
    </ul>
