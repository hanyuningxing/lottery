...
function init(playType,period){
	var url;
	if(playType=="1"){
 			url = "./../xml/ssq/hmtj/"+period+".xml";
 	}else if(playType=="2"){
 			url = "./../xml/ssq/dmtj/"+period+".xml";
 	}else{
 			url = "./../xml/ssq/shtj/"+period+".xml";
 	}
 	$.ajax({
		    url:url,
		    type: 'GET',
		    ...
		    success: function(xml){
		    	...
		    	if(playType==$("#hm").val()){
		    		...
		    		$("#sh").removeAttr("checked");
		    	}else if(playType==$("#dm").val()){
    ...
    <div class="an_select">
      <div class="an_sleft" id="">
        ...
        <label for="">
          ...
          胆码投注统计</label>
        <label for="">
          <input type="radio" name="RadioGroup1"  value="3" id="sh" onclick="ptChange('3');"/>
          杀号统计</label>
			...
			<table class="kjh_zjhm" width="228" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td class="kjh_zjhm_wz">开奖号码：</td>
					...
					<td class="kjh_zjhm_hq">${results[5]}</td>
    ...
    <div>
      ...
      <table width="978px" border="0" cellspacing="0" cellpadding="0" class="an_table" >
        <tr>
          ...
          <td class="bright_no"><div class="an_percent"><span class="red_per" id="h_32"></span></div></td>
        </tr>
        <tr class="an_num" id="">
          ...
          <td class="bright_no" ><div class="total_num"><span class="writing"id="c_32"></span></div>
      ...
      <div class="blueB_table">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="an_table">
          <tr>
            ...
            <td><div class="an_percent"><span class="blue_per" id="bh_11"></span></div></td>
            <td><div class="an_percent"><span class="blue_per" id="bh_12"></span></div></td>
            <td><div class="an_percent"><span class="blue_per" id="bh_13"></span></div></td>
            <td><div class="an_percent"><span class="blue_per" id="bh_14"></span></div></td>
            <td class="bright_no"><div class="an_percent"><span class="blue_per" id="bh_15"></span></div></td>
          </tr>
          <tr class="an_num" id="">
            <td class="left_td"><span class="an_sp1">次数</span><br />
              <span class="an_sp2"><strong>模拟选号</strong><br />
            ...
            <td ><div class="total_num"><span class="writing" id="bc_11"></span></div>
              <span class="blue_num" id="bn_11"></span><span class="curkj_no"></span></td>
            <td ><div class="total_num"><span class="writing" id="bc_12"></span></div>
              <span class="blue_num" id="bn_12"></span><span class="curkj_no"></span></td>
            <td ><div class="total_num"><span class="writing" id="bc_13"></span></div>
              <span class="blue_num" id="bn_13"></span><span class="curkj_no"></span></td>
            <td ><div class="total_num"><span class="writing" id="bc_14"></span></div>
              <span class="blue_num" id="bn_14"></span><span class="curkj_no"></span></td>
            <td class="bright_no" ><div class="total_num"><span class="writing" id="bc_15"></span></div>
              <span class="blue_num" id="bn_15"></span><span class="curkj_no"></span></td>
          </tr>
        </table>
      </div>
