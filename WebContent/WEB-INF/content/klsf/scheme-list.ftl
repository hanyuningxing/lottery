					  ...
					  <#if pagination??&& (pagination.result![])?size gt 0>
						<#list pagination.result as data>
							...
							<tr class="${trClass!}" align="center" onMouseOver="this.className='center_trhover'" onMouseOut="this.className='center_trw'">
							  ...
							  <td><a href="<@c.url value="/${lotteryType.key}/scheme!show.action?id=${data.id!}" />">查看</a>
					          	|<a href="javascript:submitReBet('${data.lotteryType.key}','${data.id}','${data.schemeNumber}','${data.schemeCost}');">再次购买</a>
					          </td>					        </tr>
				        </#list>
				      <#else>
				      <tr>
