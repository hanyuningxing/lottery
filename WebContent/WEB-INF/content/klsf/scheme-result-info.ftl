<head>
	<title>快乐十分开奖公告、号码详情_最新开奖_历史开奖 - ${webapp.webName}安全购彩平台</title>
	<meta name="Description" content="${webapp.webName}广东快乐十分网上投注频道：为广大彩民提供快乐十分的预测分析，快乐十分的购彩技巧和最新的开奖公告及实时的快乐十分走势图，是可以信赖的快乐十分网上投注安全购彩平台。" />
...
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <tr class="center_trw" align="center" >
          <td height="35" class="kj_buybg"><a href="${base}/${lotteryType.key}/analyse.action" class="graychar">${lotteryType.lotteryName}数据图表</a> | <a href="${base}/info/rule/rule.action?lottery=KLSF" class="graychar">${lotteryType.lotteryName}玩法介绍</a> | <a href="${base}/info/rule/rule.action?lottery=KLSF" class="graychar">${lotteryType.lotteryName}中奖细则</a></td>
        </tr>
        <tr class="center_trw" align="center" >
