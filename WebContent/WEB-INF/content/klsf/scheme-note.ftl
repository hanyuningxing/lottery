<head>
	<title>广东快乐十分，快乐十分网上购买投注 - ${webapp.webName}安全购彩平台</title>
								...
								<#list pagination.result as data>
							          ...
							          <td>
							               <#if data.results??>
							                ...
							                <ul class="kjball">
								                 <li <#if resultArr[0]=='19'||resultArr[0]=='20'> class="blueballsingle"<#else>class="redballsingle"</#if>>${resultArr[0]!}</li> 
								                 ...
								                 <li class="redballsingle">${resultArr[5]!}</li> 
								                 <li class="redballsingle">${resultArr[6]!}</li> 
								                 <li class="redballsingle">${resultArr[7]!}</li> 
	   										</ul>
							               </#if>
							          </td> 
