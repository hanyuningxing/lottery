<head>
	<title>江西体彩11选5开奖公告、号码详情_最新开奖_历史开奖 - ${webapp.webName}安全购彩平台</title>
        ...
        <#if periods??&&periods?size gt 0>
	         <#list periods as data>
	                <tr class="center_trw" align="center" >
			          ...
			          <td ><a href="javascript:void(0);" title="${data.results}" onclick="copyResult(this);return false;">复制号码</a></td>
			        </tr>
	         </#list>
	    </#if>
      </table>
...
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <tr class="center_trw" align="center" >
          <td height="35" class="kj_buybg"><a href="${base}/${lotteryType.key}/analyse.action" class="graychar">${lotteryType.lotteryName}数据图表</a> | <a href="${base}/info/rule/rule.action?lottery=EL11TO5" class="graychar">${lotteryType.lotteryName}玩法介绍</a> | <a href="${base}/info/rule/rule.action?lottery=EL11TO5" class="graychar">${lotteryType.lotteryName}中奖细则</a></td>
        </tr>
        <tr class="center_trw" align="center" >
