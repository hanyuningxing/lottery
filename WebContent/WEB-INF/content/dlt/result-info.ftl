<head>
	<title>大乐透开奖公告、号码详情_最新开奖_历史开奖 - ${webapp.webName}安全购彩平台</title>
...
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <tr class="center_trw" align="center" >
          <td height="28">七等奖</td>
          <td ><#if periodData.winUnit.seventhWinUnits??>${periodData.winUnit.seventhWinUnits}</#if></td>
          <td ><span class="redc"><#if periodData.prize.seventhPrize??>${periodData.prize.seventhPrize?string('###,###')}</#if> 元</span></td>
        </tr>
        <tr class="center_trw" align="center" >
          <td height="28">八等奖</td>
          <td ><#if periodData.winUnit.eighthWinUnits??>${periodData.winUnit.eighthWinUnits}</#if></td>
          <td ><span class="redc"><#if periodData.prize.eighthPrize??>${periodData.prize.eighthPrize?string('###,###')}</#if> 元</span></td>
        </tr>
        </#if>
      </table>
      <table style="background:#fff; border-collapse:collapse; border:1px solid #E3E3E3;"  
bordercolor="#dcdcdc" cellspacing="0" cellpadding="1" width="938"  
  border="1" align="center">
        ...
        <tr class="center_trw" align="center" >
          <td height="35" class="kj_buybg"><a href="${base}/${lotteryType.key}/analyse.action" class="graychar">${lotteryType.lotteryName}数据图表</a> | <a href="${base}/info/rule/rule.action?lottery=DLT" class="graychar">${lotteryType.lotteryName}玩法介绍</a> | <a href="${base}/info/rule/rule.action?lottery=DLT" class="graychar">${lotteryType.lotteryName}中奖细则</a></td>
        </tr>
        <tr class="center_trw" align="center" >
