...
<div id="note" style="width:710px;">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#D7E2E6; border:1px solid #ccc; border-top:none; color:#666; line-height:16px; font-family:Arial, Helvetica, sans-serif;">
      <tr align="center" class="tdduilist">
        ...
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">0</td>
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">1</td>
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">2</td>
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">3</td>
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">4</td>
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">5</td>
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">6</td>
        <td width="42" class="tdr1px" style="background:#FEF5D2; color:#CC4212;">7+</td>
        <td width="22" style="background:#FEF5D2; color:#CC4212;">全</td>
      </tr>
   </table>  
</div>      
<div>	    
					    ...
					    <tr class="${trClass}" align="center" id="tr_${match.matchKey}" _lid="${match.matchKey}" _m="1" _d="${entry_index}" <#if games?? && match.gameName?? && match.gameName?trim !=''>_g="${games.indexOf(match.gameName)}"</#if> _h="${match.handicap!0}" _e="<#if saleEnd>1<#else>0</#if>">
		                   ...
		                   <td id="td_bf_${match.matchKey}" width="35" class="red_F00_14">
				            ...
				            <#list itemArr as item>
				            	<td width="41" class="tdyelnor" <#if match.cancel>title="取消"</#if> <#if !saleEnd>id="JQS_td_${match.matchKey}_${item.ordinal()}" onclick="clickItem(${match_index},'${match.matchKey}',${item.ordinal()},event,'JQS');"</#if>>
				            ...
				            <td width="22" class="tdyelnor" <#if !saleEnd>onclick="rowBatch(${match_index},'${match.matchKey}',0,event,'JQS')"</#if>><#if !saleEnd><input id="JQS_bao_0_${match.matchKey}" type="checkbox" onclick="rowBatch(${match_index},'${match.matchKey}',0,event,'JQS')" align="absmiddle" autocomplete="off" /><#else>&nbsp;</#if></td>
						</tr>
