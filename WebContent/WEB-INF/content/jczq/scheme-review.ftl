...
<div class="w1000" style="border:1px solid #CCC;">
  ...
  <div style="margin:10px;">
	...
	<div style="height:40px; line-height:40px;"><span style="float:left;"><strong>竞彩开奖比赛日期选择：</strong>
        <input id="startTime" onclick="this.value='';" name="startTime" type="text" value="${startTime!}" class="zjmxrl"/>
		至
		<input id="endTime" name="endTime" onclick="this.value='';" type="text" value="${endTime!}" class="zjmxrl"/>
	    <input type="submit" name="Submit" value="开始查询" class="chaxun" onclick="document.getElementById('reviewForm').submit();return false;"/> 
...
<div id="note" style="width:980px">
  ...
  <tbody  id="matchTbody">
      <tr align="center" class="kjjgtr01">
        ...
        <td width="73" rowspan="2" bgcolor="#d5f6fd" class="kjjgtd00"><strong>客队</strong></td>
        <td width="39" rowspan="2" bgcolor="#d5f6fd" class="kjjgtd00"><strong>半场<br />
比分</strong></td>
        <td width="39" rowspan="2" bgcolor="#d5f6fd" class="kjjgtd00"><strong>全场<br />
比分</strong></td>
      <td width="80"  colspan="2" bgcolor="#d5f6fd" class="kjjgtd00"><strong>胜平负</strong></td>
      <td width="100"  colspan="3" bgcolor="#d5f6fd" class="kjjgtd00"><strong>让球胜平负</strong></td>
      <td width="73"  colspan="2" bgcolor="#d5f6fd" class="kjjgtd00"><strong>总进球数</strong></td>
      <td width="82"  colspan="2" bgcolor="#d5f6fd" class="kjjgtd00"><strong>比分</strong></td>
      <td style="width:80px" colspan="2" bgcolor="#d5f6fd" class="kjjgtd00"><strong>半全场</strong></td>
    </tr>
    <tr align="center">
     ...
     <#assign endCount=0 />
			<#if matchMap??>
				<#list matchMap.entrySet() as entry>
					...
					<#assign JQS=stack.findValue("@com.cai310.lottery.support.jczq.PlayType@JQS") />
					<#assign BF=stack.findValue("@com.cai310.lottery.support.jczq.PlayType@BF") />
					<#assign BQQ=stack.findValue("@com.cai310.lottery.support.jczq.PlayType@BQQ") />
					<#list entry.getValue() as match>
					    ...
					    <#if rs!=''><#assign rs_sp=match.getResultSp(playType)!'' /><#else><#assign rs_sp='' /></#if>
						 ...
						 <tr  align="center" id="tr_${match.matchKey}" _lid="${match.matchKey}" _m="1" _d="${entry_index}" <#if games?? && match.gameName?? && match.gameName?trim !=''>_g="${games.indexOf(match.gameName)}"</#if> _h="${match.handicap!0}" _e="1">
		                	...
		                	<td width="66" height="7%" align="center" class="kjjgtd01">
		                			<label for="hide_cbx_${match.matchKey}">${match.matchKeyText}</label>
		                	</td>
		                	
					      <td width="78" class="kjjgtd01" style="background:<#if match.gameColor?? && match.gameColor?trim != ''>${match.gameColor}<#else>${defaultJcGameColor!}</#if>; color:#fff;">${match.gameName}</td>
		                  <td width="78" class="kjjgtd01">${match.matchTime?string('MM-dd HH:mm')}</td>
					      <td width="97" class="kjjgtd01"><span <#if match.homeTeamGuangdongName?? && match.homeTeamGuangdongName !=''>_gd="${match.homeTeamGuangdongName}" _gy="${match.homeTeamName!}"</#if>>${match.homeTeamName!}</span></td>
					      <td width="97" class="kjjgtd01"><span <#if match.guestTeamGuangdongName?? && match.guestTeamGuangdongName !=''>_gd="${match.guestTeamGuangdongName}" _gy="${match.guestTeamName!}"</#if>>${match.guestTeamName!}</span></td>
					      ...
					      <#if match.cancel>
				        	...
				        	<#elseif match.ended>
							     ...
							     <td width="39" class="kjjgtd02"><#if match.getResultSp(SPF)??>${match.getResultSp(SPF)?string('0.00')}</#if></td>
							     <td width="39" class="kjjgtd01 ${handicapClass}">${match.handicap!}</td>
							     <td width="39" class="kjjgtd01 rc1"><strong><#if match.getResult(RQSPF)??>${match.getResult(RQSPF).text}</#if></strong></td>
							     <td width="39" class="kjjgtd02"><#if match.getResultSp(RQSPF)??>${match.getResultSp(RQSPF)?string('0.00')}</#if></td>
							     <td width="39" class="kjjgtd01 rc1"><strong><#if match.getResult(JQS)??>${match.getResult(JQS).text}</#if></strong></td>
							     <td width="39" class="kjjgtd02"><#if match.getResultSp(JQS)??>${match.getResultSp(JQS)?string('0.00')}</#if></td>
							     ...
							     <td width="39" class="kjjgtd01 rc1"><strong><#if match.getResult(BQQ)??>${match.getResult(BQQ).text}</#if></strong></td>
							     <td width="39" class="kjjgtd04"><#if match.getResultSp(BQQ)??>${match.getResultSp(BQQ)?string('0.00')}</#if></td>
							 <#else>
							     <td width="39" class="kjjgtd01">&nbsp;</td>
				        		 <td width="39" class="kjjgtd02">&nbsp;</td>
				        		 <td width="39" class="kjjgtd01 rc1"><strong>&nbsp;</strong></td>
							     <td width="39" class="kjjgtd02">&nbsp;</td>
							     <td width="39" class="kjjgtd01 rc1"></td>
							     <td width="39" class="kjjgtd01 rc1"><strong>&nbsp;</strong></td>
							     <td width="39" class="kjjgtd02">&nbsp;</td>
							     <td width="39" class="kjjgtd01 rc1"><strong>&nbsp;</strong></td>
							     <td width="39" class="kjjgtd02">&nbsp;</td>
