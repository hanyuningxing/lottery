<head>
	...
	<script type="text/javascript" src="<@c.url value= "/js/analyse/pl/pl3_miss_zx.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/pl/pl3_miss_ch.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/pl/base.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/pl/chzs.js"/>"></script>
