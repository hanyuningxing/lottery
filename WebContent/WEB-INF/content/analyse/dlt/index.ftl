<head>
	<title>${lotteryType.lotteryName}综合走势</title>
	...
	<script type="text/javascript" src="<@c.url value= "/js/analyse/welfare3d/w3d_miss_zx.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/welfare3d/w3d_miss_ch.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/welfare3d/base.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/welfare3d/chzs.js"/>"></script>
