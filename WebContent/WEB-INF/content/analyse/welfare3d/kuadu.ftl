<head>
	...
	<script type="text/javascript" src="<@c.url value= "/js/analyse/welfare3d/w3d_kd.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/welfare3d/base.js"/>"></script>
	<script type="text/javascript" src="<@c.url value= "/js/analyse/welfare3d/kdzs.js"/>"></script>
