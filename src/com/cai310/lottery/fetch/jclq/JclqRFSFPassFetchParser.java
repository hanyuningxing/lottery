...
public class JclqRFSFPassFetchParser extends JclqSimplePassFetchParser {

	@Override
	public String getSourceUrl() {
		return "http://i.sporttery.cn/odds_calculator/get_odds?i_format=json&i_callback=getData&poolcode[]=hdc";
	}
	...
	public Map<String, Double> getItemMap(JclqMatchDto matchDto) {
		...
		itemMap.put(REDUCED_VALUE_KEY, Double.valueOf(matchDto.getSingleHandicap()));
		return itemMap;
	}
}