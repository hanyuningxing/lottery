...
public class JczqRFSPFPassFetchParser extends JczqSimplePassFetchParser {
 
	@Override
	public String getSourceUrl() {
//		return "http://info.sporttery.cn/lotterygame/hhad_list.php";
//		return "http://info.sporttery.cn/football/hhad_list.php";
		return "http://i.sporttery.cn/odds_calculator/get_odds?i_format=json&poolcode[]=hhad";
	}
