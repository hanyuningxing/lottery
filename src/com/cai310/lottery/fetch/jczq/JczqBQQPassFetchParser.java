...
public class JczqBQQPassFetchParser extends JczqSimplePassFetchParser {

	@Override
	public String getSourceUrl() {
//		return "http://info.sporttery.cn/lotterygame/hafu_list.php";
//		return "http://info.sporttery.cn/football/cal_hafu.htm";
		return "http://i.sporttery.cn/odds_calculator/get_odds?i_format=json&poolcode[]=hafu";
	}
