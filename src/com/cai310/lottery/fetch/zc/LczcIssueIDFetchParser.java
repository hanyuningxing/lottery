...
public class LczcIssueIDFetchParser extends OkoooAbstractFetchParser{
	private static final String URL = "http://www.310win.com/zucai/6changbanquanchang/kaijiang_zc_3.html";
	...
	public static void main(String[] args) {
		LczcIssueIDFetchParser p = new LczcIssueIDFetchParser();
