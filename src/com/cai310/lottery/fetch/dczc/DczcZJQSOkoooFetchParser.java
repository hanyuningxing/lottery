...
public class DczcZJQSOkoooFetchParser extends DczcOkoooFetchParser {

	@Override
	public PlayType getPlayType() {
		return PlayType.ZJQS;
	}
	...
	protected String getSourceXml() {
		return "http://buy.okooo.com/Upload/xml/45.xml";
	}
