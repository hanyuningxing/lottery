...
public class FetchConstant {
	...
	//胜负彩
	public static final String SFCURL="http://odds.hclotto/index.php?controller=sfcodds&action=index&tp=1";
	//进球彩
	public static final String JQCURL="http://odds.hclotto/index.php?controller=jqodds&action=index&tp=3";
	//半全场
	public static final String BQCURL="http://odds.hclotto/index.php?controller=bqodds&action=index&tp=4";

	public static final String XYO_URL = "http://odds.hclotto/index.php?controller=bdodds&action=index&tp=5";
