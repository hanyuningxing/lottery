...
public class QueryServiceImpl implements QueryService {
	 ...
	 */
	@Autowired
	public void setSessionFactory(@Qualifier(Constant.SESSIONFACTORY) SessionFactory sessionFactory) {
	...
	public List findByHql(String queryString, Map<String, Object> paramMap,Integer first,Integer count, ResultTransformer transformer) {
		Query query = getSession().createQuery(queryString);// 创建查询对象
		if (paramMap != null && paramMap.size() > 0) {
			query.setProperties(paramMap);// 设置查询参数
		}
