...
@Service("qyhMissDataControllerServiceImpl")
public class QyhMissDataControllerServiceImpl extends MissDataControllerServiceImpl<QyhMissDataInfo, QyhIssueData> {
	@Autowired
	private QyhIssueDataDao issueDataDao;
	@Autowired
	private QyhMissDataEntityManagerImpl missDataEntityManager;
	@Override
	...
	public void createMissFiles() {
		...
		WriteHTMLUtil.writeHtm("/js/analyse/"+getLottery().getKey()+"/", "qyhdata.js", "dataQyh="+resultRoot.toString()+";function getdata(){return dataQyh;}", "UTF-8");
		WriteHTMLUtil.writeHtm("/js/analyse/"+getLottery().getKey()+"/", "qyh_num.js", "qyhNum="+numRoot.toString(), "UTF-8");
	...
	@Override
	public MissDataEntityManagerImpl<QyhMissDataInfo,QyhIssueData> getMissDataManager() {
	...
	private void createMaxMissFiles(JSONObject miss1,JSONObject miss2,JSONObject miss3,JSONObject miss4,JSONObject miss5){
		...
		WriteHTMLUtil.writeHtm("/js/analyse/"+getLottery().getKey()+"/","qyh_max_miss.js", "qyh_max_miss="+root+";", "UTF-8");
	}
