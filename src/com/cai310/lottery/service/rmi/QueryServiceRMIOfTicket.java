 ...
 * 
 */
public interface QueryServiceRMIOfTicket {
	...
	List findByHql(String queryString, Map<String, Object> paramMap,Integer first,Integer count, ResultTransformer transformer);
