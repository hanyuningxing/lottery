...
public class JczqSchemeConverWork <T extends JczqMatchItem>{
	// ===================================================================
	 ...
	 */
	public JczqSchemeConverWork(int combinNum, List<T> danCorrectList, List<T> unDanCorrectList, int danMinHit,
			int danMaxHit) {
