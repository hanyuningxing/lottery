...
public class PrizeForecastDetailItem implements Serializable {
	...
	private final List<List<JclqExtraMatchItem>> detailList;
	...
	public PrizeForecastDetailItem(Integer multiple, Double totalPrize, List<List<JclqExtraMatchItem>> detailList,
			String detail) {
	...
	public List<List<JclqExtraMatchItem>> getDetailList() {
		return detailList;
	}
