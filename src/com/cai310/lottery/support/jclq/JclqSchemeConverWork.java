...
public class JclqSchemeConverWork <T extends JclqMatchItem>{
	// ===================================================================
	 ...
	 */
	public JclqSchemeConverWork(int combinNum, List<T> danCorrectList, List<T> unDanCorrectList, int danMinHit,
			int danMaxHit) {
