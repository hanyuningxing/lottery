...
public class Tc22to5Order implements Comparable<Tc22to5Order> {
	 ...
	 * @param isPoly 是否单复式
	 */
	public void calcWin(Tc22to5PeriodData periodData, boolean isPoly) {
		this.winUnit = Tc22to5Win.calcWinUnit(periodData.getResult(), this.betUnits, this.multiple, isPoly);
	}
