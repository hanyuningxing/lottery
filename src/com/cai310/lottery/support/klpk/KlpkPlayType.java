...
public enum KlpkPlayType {
	 ...
	 * 中奖条件：3个开奖号码为任意相同花色
	 */
	SAMEBAO("同花包选", Integer.valueOf("22"),1) {
	 ...
	 * 中奖条件：所选花色与3个开奖号花色相同
	 */
	SAME("同花单选", Integer.valueOf("90"),1) {
		public KlpkWinUnits calcWinUnit(Integer[] results, KlpkCompoundContent klpkCompoundContent, int multiple) {
			KlpkWinUnits klpkWinUnits = new KlpkWinUnits();
			int hua1 = results[0];
			int hua2 = results[2];
...
//		}
	 ...
	 */
	SHUNBAO("顺子包选", Integer.valueOf("33"),1) {
		public KlpkWinUnits calcWinUnit(Integer[] results, KlpkCompoundContent klpkCompoundContent, int multiple) {
			KlpkWinUnits klpkWinUnits = new KlpkWinUnits();
			int hao1 = results[1];
			int hao2 = results[3];
	 ...
	 */
	SHUN("顺子单选 ", Integer.valueOf("400"),3) {
...
//		}
	 ...
	 * 中奖条件：3个开奖号码为3连号（不分花色）
	 */
	DUIBAO("对子包选", Integer.valueOf("7"),1) {
		public KlpkWinUnits calcWinUnit(Integer[] results, KlpkCompoundContent klpkCompoundContent, int multiple) {
			KlpkWinUnits klpkWinUnits = new KlpkWinUnits();
			int hao1 = results[1];
			int hao2 = results[3];
...
//		}
	 ...
	 */
	RandomOne("任选一 ", Integer.valueOf("5"),1) {
