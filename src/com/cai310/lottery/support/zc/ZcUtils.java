...
public class ZcUtils {
	...
	public static int SFZC14_MATCH_COUNT = 14;
	public static int SFZC9_MATCH_COUNT = 14;
	public static int SFZC9_MATCH_MINSELECT_COUNT = 9;
	public static int LCZC_MATCH_COUNT = 6;
	public static int SCZC_MATCH_COUNT = 4;	
