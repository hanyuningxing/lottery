...
public enum Lottery {
	 ...
	 */
	private Lottery(String key, String lotteryName, String schemeNumberPrefix, LotteryCategory category,String title) {
		this(key, lotteryName, lotteryName, schemeNumberPrefix, category, title);
	}
	...
	private Lottery(String key, String simpleName, String lotteryName, String schemeNumberPrefix,
			LotteryCategory category,String title) {
		this.key = key;
	 ...
	 * 
	 * @param schemeNumber 方案号
	 * @param schemeNumber 彩种
	 * @return 彩票类型
	 */
	public static boolean isSchemeNumber(String schemeNumber, Lottery lotteryType) {
		if (StringUtils.isNotBlank(schemeNumber)) {
			if (schemeNumber.matches(lotteryType.schemeNumberRegex)) {
				return true;
			}
		}
		return false;
