...
@Action(SscConstant.KEY)
public class SscCounterController extends KenoCounterController<SscScheme> {
	...
	public SscPlayType getPlayType() {
		return playType;
	}

	public void setPlayType(SscPlayType playType) {
