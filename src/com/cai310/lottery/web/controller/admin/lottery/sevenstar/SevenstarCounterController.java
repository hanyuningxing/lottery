...
@Action(SevenstarConstant.KEY)
public class SevenstarCounterController extends CounterController<SevenstarScheme> {
	private static final long serialVersionUID = 4344862033511801247L;
