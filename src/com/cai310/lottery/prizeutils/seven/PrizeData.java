...
public class PrizeData {
	...
	public String getPrizeDetail() {
		...
		if (sevenWinUnits > 0) {
			...
			varWonLineText.setVar("WINUNITS", sevenWinUnits);
			varWonLineText.setVar("PRIZE", sevenWinUnits * sevenPrize >= 10000.0d ? sevenWinUnits * sevenPrize * 0.8d
					: sixthWinUnits * sixthPrize);
			prizeDesc += varWonLineText.toString();
		}
		return prizeDesc;
	...
	public double getPrizeAfterTax() {
		...
		if (sevenWinUnits > 0) {
			prize += sevenWinUnits * sevenPrize >= 10000.0d ? sevenWinUnits * sevenPrize * 0.8d : sevenWinUnits
					* sevenPrize;//
		}
		return prize;
	}
	...
	public double getPrize() {
		...
		if (sevenWinUnits > 0) {
			prize += sevenWinUnits * sevenPrize;//
		}
		return prize;
	}
	...
	protected void addSevenWinUnits(int sevenWinUnits) {
		this.sevenWinUnits += sixthWinUnits;
	}
