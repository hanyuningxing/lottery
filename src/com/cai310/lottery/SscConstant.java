...
public class SscConstant {
	...
	/** 四星直选复式内容正则表达式 */
	public static final String DirectFour_COMPOUND_REGEX = "^\\s*(\\d{1,5}):(\\d{1,2}(,\\d{1,2}){0,9}(-\\d{1,2}(,\\d{1,2}){0,9}){3})\\s*$";
	...
	/** 五星值选单式内容正则表达式 */
	public static final String DirectFive_SINGLE_REGEX = "^\\s*(\\d{1,2}(\\d{1,2}){4})\\s*$";
	/** 三星值选单式内容正则表达式 */
	public static final String DirectThree_SINGLE_REGEX = "^\\s*(\\d{1,2}(\\d{1,2}){2})\\s*$";
	/** 二星值选单式内容正则表达式 */
	public static final String DirectTwo_SINGLE_REGEX = "^\\s*(\\d{1,2}(\\d{1,2}){1})\\s*$";
	/** 一星值选单式内容正则表达式 */
	public static final String DirectOne_SINGLE_REGEX = "^\\s*(\\d{1,2}(\\d{1,2}){0})\\s*$";
