 ...
 * 
 */
public class CombinationUtil_Jczq<T extends JczqMatchItem> {
	 ...
	 */
	public CombinationUtil_Jczq(int combinNum, List<T> danCorrectList, List<T> unDanCorrectList, int danMinHit,
			int danMaxHit) {
	...
	private void init() {
		JczqExtensionCombCallBack call = new JczqExtensionCombCallBack();
	...
	class JczqExtensionCombCallBack implements ExtensionCombCallBack {
