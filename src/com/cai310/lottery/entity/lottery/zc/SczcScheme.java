 ...
 * 
 */
@Table(name = com.cai310.lottery.Constant.LOTTERY_TABLE_PREFIX + "SCZC_SCHEME")
@Entity
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = CacheConstant.H_SCHEME_CACHE_REGION)
public class SczcScheme extends Scheme {
	 ...
	 */
	@Transient
	public SczcCompoundItem[] getCompoundContent() throws DataException {
	...
	public String getContentString() throws DataException {
		...
		for (SczcCompoundItem item : this.getCompoundContent()) {
