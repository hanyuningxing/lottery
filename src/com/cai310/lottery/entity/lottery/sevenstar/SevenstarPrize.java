...
@Embeddable
public class SevenstarPrize implements Serializable {
	...
	public int calcTotalPrize(SevenstarWinUnit winUnit) {
		int totalPrize = 0;
	...
	public List<PrizeItem> getPrizeItemList(SevenstarWinUnit winUnit) {
