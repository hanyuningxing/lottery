...
@Embeddable
public class SevenWinUnit implements Comparable<SevenWinUnit>, Serializable {
	...
	public void addWinUnit(SevenWinUnit winUnit) {
		...
		this.addSevenWinUnits(winUnit.getSevenWinUnits());
	}
	
	public void addSevenWinUnits(Integer winUnits) {
		if (winUnits != null) {
			if (this.getSevenWinUnits() == null) {
				this.setSevenWinUnits(winUnits);
			} else {
				this.setSevenWinUnits(this.getSevenWinUnits() + winUnits);
			}
		}
	}
	...
	public void reset() {
		...
		this.setSevenWinUnits(null);
	}

	@Transient
	protected Integer[] getWinUnits() {
		return new Integer[] { this.getFirstWinUnits(), this.getSecondWinUnits(), this.getThirdWinUnits(),
				this.getFourthWinUnits(), this.getFifthWinUnits(), this.getSixthWinUnits() , this.getSevenWinUnits() };
	}

	public int compareTo(SevenWinUnit winUnit2) {
		if (winUnit2 == null)
			return -1;
	...
	public String toString() {
		return "一等奖:" + this.firstWinUnits.toString() + "   二等奖:" + this.secondWinUnits.toString() + "   三等奖:"
				...
				+ this.fifthWinUnits.toString() + "    六等奖:" + this.sixthWinUnits.toString() +"    七等奖:" + this.sevenWinUnits.toString();
	}
}
