 ...
 * 
 */
@Table(name = JclqSchemeMatch.TABLE_NAME)
@Entity
public class JclqSchemeMatch extends IdEntity {
	private static final long serialVersionUID = -7252913036254858708L;
	public static final String TABLE_NAME = com.cai310.lottery.Constant.LOTTERY_TABLE_PREFIX + "JCLQ_SCHEME_MATCH";
	/** 方案编号 */
