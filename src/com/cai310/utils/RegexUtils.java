...
public class RegexUtils {
	...
	/** 由26个英文字母或中文组成的字符串 */
	public static final String LetterAndChinese = "^[A-Za-z\u4e00-\u9fa5]+$";
	...
	public static void main(String[] args) throws WebDataException {
		if (!"342423197401265877".matches(RegexUtils.IdCard))
